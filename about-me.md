...
<div class="card">
 ...
 <p>
    I teach courses in both <strong>Sociological Theory and Method</strong>, including <strong>Sociology of Health</strong, 
...
<div class="card">
  ...
  <ul>
    ...
    <li><i class="fas fa-user-md icon"></i> Access to Healthcare</li>
