...
As a quantitative researcher with interests in survey methodology, applied statistics, and machine learning, I work with multiple national surveys with complex sampling designs to analyze disparities in mental health outcomes in Canada. My goal is to recommend data-driven and evidence-based policies to improve the mental health of youth and young adults at the population level.
