...
- **Ranked 4<sup>th</sup>** in the Iranian University Entrance Exam for M.A. Degrees in Social Sciences (`<span style="color:grey;">4<sup>th</sup></span>`) in **Demography**, (`<span style="color:grey;">5<sup>th</sup></span>`) in **Anthropology**, 2015.
