...
- Experienced in **Advanced Statistical Modeling and Data Analysis** with `R` and `Python` - `multiple imputation`, `mixed-effects models`, `latent class analysis`, `logistic and ordinal regression`  
