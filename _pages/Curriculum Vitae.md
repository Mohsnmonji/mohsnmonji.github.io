...
- Experienced in **Advanced Statistical Data Analysis** with `R` and `Python`: Multiple imputation, Mixed-effects models, latent class analysis, logistic and ordinal regression
